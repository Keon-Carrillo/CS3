...
if birthYear < 1900:
    ...
    #Modulus uses division to check how many times the zodiacs (12) have been fully cycled and grabs the remainder to determine your birth year's place
    if yearsPassed % 12 == 0:
        print("Your Chinese zodiac sign is: Rat (鼠 / Shǔ)")

    elif yearsPassed % 12 == 1:
